...
end_product: GDD — every mechanic in REQUIREMENTS.md scored against every pillar; orphan/weak-signal mechanics flagged for cut/keep
canonical_path: .planning/phases/01-foundations-vision-lock/deliverables/loops-journey-pack/07-pillar-mechanic-matrix.md
source_decisions: D-SCOPE-07, D-VISION-01..09 (premise drives scoring)
input_dependencies:
  - 02-pillars-of-play.md (column headers — Pillar 1 Character Development, Pillar 2 Never Punishing, Pillar 3 Approachability)
  - .planning/REQUIREMENTS.md (mechanic rows — every gameplay-relevant REQ-ID)
...
hard_guardrails:
  ...
  - Sprite-premise reinterpretation REQs (HOME-01..05, CRAFT-01..07, COMP-01, NPC-06, NPC-09, ROM-01/02 per 26-architecture-ratification.md) are scored under D-VISION-08 reinterpretation; final REQUIREMENTS.md amendments deferred to Phase 1 → Phase 2 transition
order: third doc in Game Design Doc group; depends on pillars + REQUIREMENTS.md
---
